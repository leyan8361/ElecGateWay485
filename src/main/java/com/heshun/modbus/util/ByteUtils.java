...
public class ByteUtils {
	...
	// ByteUtils.append(bytes, 0, ByteUtils.shortToByte2(CpmUtils.PACKET_HEAD));
	// ByteUtils.append(bytes, 2, ByteUtils.shortToByte2((short)0x0005));
	// ByteUtils.append(bytes, 4, ByteUtils.intToByte4(CpmUtils.CMD_FLOW));
	// ByteUtils.append(bytes, 8, ByteUtils.shortToByte2((short)0x0006));
	// ByteUtils.append(bytes, 10, ByteUtils.shortToByte2((short)0x0002));
	//
