...
public class YH396EStrategy extends Abs485UnpackStrategy<YH396EPacket, YH396EConvert> {

	public YH396EStrategy(IoSession s, IoBuffer b) {
		super(s, b);
	}

	@Override
	public YH396EConvert getConvert(YH396EPacket packet) {
		return new YH396EConvert(packet);
	}

	@Override
	public YH396EConvert initConvert(int address) {
		return new YH396EConvert(new YH396EPacket(address));
	}

	@Override
	protected YH396EPacket handle(String signature, List<Byte> packet, YH396EConvert convert) {
		YH396EPacket p = convert.getOriginal();
