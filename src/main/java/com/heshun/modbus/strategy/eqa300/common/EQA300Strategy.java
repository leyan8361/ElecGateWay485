package com.heshun.modbus.strategy.eqa300.common;
...
public class EQA300Strategy extends Abs485UnpackStrategy<EQA300Packet, EQA300Convert> {

	public EQA300Strategy(IoSession s, IoBuffer b) {
		super(s, b);
	}
	...
	@Override
	public EQA300Convert initConvert(int address) {
		return new EQA300Convert(new EQA300Packet(address));
	}

	@Override
	protected EQA300Packet handle(String signature, List<Byte> packet, EQA300Convert convert) {
		EQA300Packet p = convert.getOriginal();
