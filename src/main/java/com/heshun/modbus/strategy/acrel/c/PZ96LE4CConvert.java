...
public class PZ96LE4CConvert extends AbsJsonConvert<PZ96LE4CPacket> {

	public PZ96LE4CConvert(PZ96LE4CPacket packet) {
		super(packet);
	}
	...
	private float formatU(short _original) {
		return (float) ((double) _original * Math.pow(10, (mPacket._dpt - 4)));
	}

	private float formatI(short _original) {
		return (float) ((double) _original * Math.pow(10, (mPacket._dct - 4)));
	}

	private float formatPQ(short _original) {
		return (float) ((double) _original * Math.pow(10, (mPacket._dpq - 4)));
	}
